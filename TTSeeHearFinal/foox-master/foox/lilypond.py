...
def render(species, cantus_firmus, contrapunctus, title='Untitled',
    ...
    print "Contrapunctus---: ", contrapunctus_notes
    ownOutput = open('contrapunto.txt', 'w')
    #ownOutput.write("contrapunto = \"" +str(contrapunctus_notes)+ "\"")
    ownOutput.write(str(contrapunctus_notes))
    ownOutput.close()
