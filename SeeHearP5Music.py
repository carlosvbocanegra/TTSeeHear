...
notes = (modeScale[0],'r',modeScale[4],modeScale[2],'r',modeScale[1],modeScale[3],'r',modeScale[5],modeScale[6])
...
instrument = ""
#Instruments:
if im.satAverage <= 0.10:
	instrument = "contrabass"
elif im.satAverage <= 0.20:
 	instrument = "cello"
...
call(["lilypond","melolisa.ly"])
#call(["timidity","melolisa.midi"])
